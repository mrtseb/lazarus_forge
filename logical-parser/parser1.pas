...
begin
   simule:=true;
   (self.Panel1.Controls[0] as Tcheckbox).Enabled:=false;
   (self.Panel1.Controls[1] as Tcheckbox).Enabled:=false;
   form2.show;
end;
...
begin
  self.ListBox2Click(self);
end;

procedure TForm1.FormClose(Sender: TObject; var CloseAction: TCloseAction);
begin
  form2.serial.WriteData(form2.cb_out.Text[2]+'-0.');
  form2.serial.close;
  form2.serial.Active:=false;
end;
...
if (panel2.Controls[0] as Tsinglebit).Value then
  form2.serial.WriteData(form2.cb_out.Text[2]+'-255.')
else
  form2.serial.WriteData(form2.cb_out.Text[2]+'-0.')
